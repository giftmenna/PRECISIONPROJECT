...
export default function AdminPracticeQuestionsPage() {
  ...
  const fetchQuestions = async () => {
    try {
      setLoading(true);
      // Use the existing questions API
      const response = await fetch("/api/admin/questions");
      if (response.ok) {
        const data = await response.json();
        // Filter for practice questions or show all
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Create and manage questions for student practice sessions
        </p>
      </div>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Button onClick={() => router.push("/admin/questions/create")} className="w-full">
        ...
        {filteredQuestions.length === 0 ? (
          <Card>
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                No practice questions found. Add your first question to get started.
              </p>
            </CardContent>
          </Card>
        ) : (
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Badge variant="outline">{question.topic.replace(/_/g, ' ')}</Badge>
                    </div>
